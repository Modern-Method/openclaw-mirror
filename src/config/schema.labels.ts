...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "agents.defaults.compaction.v2": "Compaction v2",
  "agents.defaults.compaction.v2.enabled": "Compaction v2 Enabled",
  "agents.defaults.compaction.v2.templateVersion": "Compaction v2 Template Version",
  "agents.defaults.compaction.v2.maxSummaryNodes": "Compaction v2 Max Summary Nodes",
  "agents.defaults.compaction.v2.maxNodeTokens": "Compaction v2 Max Node Tokens",
  "agents.defaults.compaction.v2.maxChainTokens": "Compaction v2 Max Chain Tokens",
  "agents.defaults.compaction.v2.mergePolicy": "Compaction v2 Merge Policy",
  "agents.defaults.compaction.v2.pinnedFactsPath": "Compaction v2 Pinned Facts Path",
